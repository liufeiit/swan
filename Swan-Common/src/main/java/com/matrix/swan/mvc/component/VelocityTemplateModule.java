...
import com.matrix.swan.mvc.velocity.VelocityAware;
 ...
 */
public class VelocityTemplateModule extends BaseWebModule implements VelocityAware {
	/** 所有模板文件的根路径 */
	...
	protected RuntimeServices runtimeServices = null;
	/** 当前上下文 */
